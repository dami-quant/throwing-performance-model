...
### GitHub Actions Badges (Add to top of README)

```markdown
![CI - Code Quality & Testing](https://github.com/<username>/<repo>/workflows/CI%20-%20Code%20Quality%20&%20Testing/badge.svg)
![Streamlit App Validation](https://github.com/<username>/<repo>/workflows/Streamlit%20App%20Validation/badge.svg)
```
